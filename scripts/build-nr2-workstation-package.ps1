...
foreach ($f in @('Install.bat', 'Start-NR2-Workstation.bat', 'Start-NR2-Workstation-Hidden.bat', 'Start-NR2-Workstation-Hidden.vbs', 'Start-Workstation.ps1', 'Setup-Workstation.ps1', 'Register-NR2WorkstationStartup.ps1', '.env.example')) {

"""Run focused import/cache/document-source tests and persist the result."""
...
TEST_MODULES = [
    "test_direct_first_imports",
    "test_document_source_import",
]


def main() -> int:
    repo_root = Path(__file__).resolve().parents[1]
    output_path = repo_root / "data" / "import_cache_slice_validation.json"

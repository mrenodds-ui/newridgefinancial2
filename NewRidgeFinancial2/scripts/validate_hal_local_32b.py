#!/usr/bin/env python3
"""Validate HAL single-32B local readiness and run a controlled prompt suite.
...
from integration_health import (  # noqa: E402
    ...
    probe_local_32b_readiness,
)

BASE = os.environ.get("NR2_OLLAMA_BASE", "http://127.0.0.1:11434")
RESULTS_DIR = NR2 / "docs" / "hal-local-32b-test-results"
...
def run_stability(model: str, minutes: int, interval_sec: int) -> dict[str, Any]:
    ...
    while time.time() < deadline:
        gate = probe_local_32b_readiness(BASE)
        try:

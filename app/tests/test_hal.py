...
def test_hal_status_includes_operating_picture(monkeypatch):
    monkeypatch.setattr(
        ...
        lambda base_url, timeout_seconds=5: {
            ...
            "running": True,
            "api_reachable": True,
            "installed_models": ["queen3:14b", "qwen2.5-coder:14b"],
            "model_count": 3,
            "error": None,
        },
    )
    ...
    assert operating_picture["model_routing"]["primary"]["model"] == "queen3:14b"
    assert operating_picture["model_routing"]["second_opinion"]["model"] == "queen3:14b"
    assert operating_picture["model_routing"]["code_help"]["model"] == "queen3:14b"

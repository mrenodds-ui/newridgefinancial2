...
class HalSoftDentLocalPacketRequest(BaseModel):
    draft_artifact: HalSoftDentDraftResponse
    packet_type: Literal[
    ...
    approval_attestation: HalSoftDentPacketApprovalAttestation


class HalSoftDentLocalPacketResponse(BaseModel):
    packet_id: str
    source_draft_id: str
    packet_type: str
    patient_label: str

...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "run_fast_review_check": (".fast_review_checker", "run_fast_review_check"),
    ...
    "list_governed_hal_memories": (".memory_workflow", "list_governed_hal_memories"),
    "propose_hal_memory": (".memory_workflow", "propose_hal_memory"),
    "approve_hal_memory": (".memory_workflow", "approve_hal_memory"),
    "revoke_hal_memory": (".memory_workflow", "revoke_hal_memory"),
